class Sensor{
    ...
    #getReadings(ray , roadBorders , traffic)
    {
        ...
        {
            // The below script is little bit complex as it uses modern JavaScript 
            // but the output is out of many obstacles the car senser it outputs the one with lowest offset between the car and obstacle
